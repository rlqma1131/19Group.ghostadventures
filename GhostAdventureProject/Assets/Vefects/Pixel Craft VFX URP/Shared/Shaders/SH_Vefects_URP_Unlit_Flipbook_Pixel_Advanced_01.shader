	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float Opacity_VTC_W158 = IN.ase_texcoord4.z;
				float Opacity_VTC_T152 = IN.ase_texcoord4.w;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float mainTex_alpha48 = tex2DNode45.a;
				float mainTex_VC_alha52 = IN.ase_color.a;
				float Opacity_VTC_W158 = IN.ase_texcoord3.z;
				float Opacity_VTC_T152 = IN.ase_texcoord3.w;
				float temp_output_167_0 = (( Opacity_VTC_T152 - 1.0 ) + (Opacity_VTC_W158 - 0.0) * (1.0 - ( Opacity_VTC_T152 - 1.0 )) / (1.0 - 0.0));
...
ASEEND*/
//CHKSM=10A54DCA2115DD906019FF6B6585B3D069931F82