	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float4 color129 = ( ( ( IN.ase_color * float4( _OverallTint.rgb , 0.0 ) ) * float4( hsvTorgb125 , 0.0 ) ) * _Emissive );
...
ASEEND*/
//CHKSM=B7D417FE4E2A940EE835C1C169AB6BCC612BEB1F